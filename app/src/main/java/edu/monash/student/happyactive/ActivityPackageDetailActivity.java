 ...
 * in a {@link ActivityPackageListActivity}.
 */
public class ActivityPackageDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(ActivityPackageDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(ActivityPackageDetailFragment.ARG_ITEM_ID));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, ActivityPackageListActivity.class));
            return true;
        }
